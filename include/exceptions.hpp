...
#ifndef MINER_EXCEPTION_H
#define MINER_EXCEPTION_H
...
class CBitcoinException: public std::exception
{
private:
	int code;
	std::string msg;
...
public:
	explicit CBitcoinException(int errcode, const std::string& message) {
