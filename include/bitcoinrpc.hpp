...
public:
    ...
    CBitcoinAPI(const std::string& user, const std::string& password, const std::string& host, int port, int httpTimeout = 50000);
    ~CBitcoinAPI();
    ...
    getblockchaininfo_t getblockchaininfo();
    void stop();
    ...
    blocktemplate_t getblocktemplate();
    std::string submitblock(const std::string& nextblockstring);
    workdata_t getwork();
