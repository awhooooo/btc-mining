...
CBitcoinAPI::CBitcoinAPI(const string& user, const string& password, const string& host, int port, int httpTimeout)
...
CBitcoinAPI::~CBitcoinAPI()
{
    delete client;
    delete httpClient;
}

Value CBitcoinAPI::sendcommand(const string& command, const Value& params){    
    Value result;
    ...
    try{
		...
		CBitcoinException err(e.GetCode(), e.GetMessage());
		throw err;
	}
...
string CBitcoinAPI::IntegerToString(int num){
	std::ostringstream ss;
	ss << num;
	return ss.str();
}

std::string CBitcoinAPI::RoundDouble(double num)
{
	std::ostringstream ss;
	ss.precision(8);
...
/* === General functions === */
getblockchaininfo_t CBitcoinAPI::getblockchaininfo() {
	string command = "getblockchaininfo";
	Value params, result;
	getblockchaininfo_t ret;
...
/* === Node functions === */
void CBitcoinAPI::addnode(const string& node, const string& comm) {
...
vector<nodeinfo_t> CBitcoinAPI::getaddednodeinfo(bool dns) {
...
vector<nodeinfo_t> CBitcoinAPI::getaddednodeinfo(bool dns, const std::string& node) {
	string command = "getaddednodeinfo";
	Value params, result;
	vector<nodeinfo_t> ret;
...
int CBitcoinAPI::getconnectioncount() {
...
vector<peerinfo_t> CBitcoinAPI::getpeerinfo() {
...
/* === Wallet functions === */
void CBitcoinAPI::backupwallet(const string& destination) {
...
string CBitcoinAPI::encryptwallet(const string& passphrase) {
...
void CBitcoinAPI::walletlock() {
	string command = "walletlock";
	Value params;
	sendcommand(command, params);
}

void CBitcoinAPI::walletpassphrase(const string& passphrase, int timeout) {
...
void CBitcoinAPI::walletpassphrasechange(const string& oldpassphrase, const string& newpassphrase) {
...
string CBitcoinAPI::dumpprivkey(const string& bitcoinaddress) {
...
void CBitcoinAPI::importprivkey(const string& bitcoinprivkey) {
...
void CBitcoinAPI::importprivkey(const string& bitcoinprivkey, const string& label, bool rescan) {
	string command = "importprivkey";
	Value params;
	params.append(bitcoinprivkey);
	params.append(label);
...
void CBitcoinAPI::importaddress(const string& address, const string& account, bool rescan) {
...
string CBitcoinAPI::addmultisigaddress(int nrequired, const vector<string>& keys) {
...
string CBitcoinAPI::addmultisigaddress(int nrequired, const vector<string>& keys, const string& account) {
	string command = "addmultisigaddress";
	Value params, result;
	params.append(nrequired);
...
multisig_t CBitcoinAPI::createmultisig(int nrequired, const vector<string>& keys) {
...
string CBitcoinAPI::getnewaddress(const string& account) {
...
validateaddress_t CBitcoinAPI::validateaddress(const string& bitcoinaddress) {
...
void CBitcoinAPI::keypoolrefill() {
	string command = "keypoolrefill";
	Value params;
	sendcommand(command, params);
}

bool CBitcoinAPI::settxfee(double amount) {
...
double CBitcoinAPI::estimatefee(int blocks) {
...
string CBitcoinAPI::signmessage(const std::string& bitcoinaddress, const std::string& message) {
...
bool CBitcoinAPI::verifymessage(const std::string& bitcoinaddress, const std::string& signature, const std::string& message) {
...
double CBitcoinAPI::getbalance(const string& account, int minconf, bool includewatchonly) {
	string command = "getbalance";
	Value params, result;
	params.append(account);
...
double CBitcoinAPI::getunconfirmedbalance() {
...
double CBitcoinAPI::getreceivedbyaccount(const string& account, int minconf) {
...
double CBitcoinAPI::getreceivedbyaddress(const string& bitcoinaddress, int minconf) {
...
vector<accountinfo_t> CBitcoinAPI::listreceivedbyaccount(int minconf, bool includeempty) {
...
vector<addressinfo_t> CBitcoinAPI::listreceivedbyaddress(int minconf, bool includeempty) {
...
gettransaction_t CBitcoinAPI::gettransaction(const string& tx, bool watch) {
...
vector<transactioninfo_t> CBitcoinAPI::listtransactions() {
...
vector<transactioninfo_t> CBitcoinAPI::listtransactions(const string& account, int count, int from) {
	string command = "listtransactions";
	Value params, result;
	vector<transactioninfo_t> ret;
...
string CBitcoinAPI::getaccount(const string& bitcoinaddress) {
...
string CBitcoinAPI::getaccountaddress(const string& account) {
...
vector<std::string> CBitcoinAPI::getaddressesbyaccount(const string& account) {
...
map<string, double> CBitcoinAPI::listaccounts(int minconf) {
...
vector< vector<addressgrouping_t> > CBitcoinAPI::listaddressgroupings() {
...
bool CBitcoinAPI::move(const string& fromaccount, const string& toaccount, double amount, int minconf) {
	string command = "move";
	Value params, result;
...
bool CBitcoinAPI::move(const string& fromaccount, const string& toaccount, double amount, const string& comment, int minconf) {
	string command = "move";
	Value params, result;
...
void CBitcoinAPI::setaccount(const string& bitcoinaddress, const string& account){
...
string CBitcoinAPI::sendtoaddress(const string& bitcoinaddress, double amount) {
...
string CBitcoinAPI::sendtoaddress(const string& bitcoinaddress, double amount, const string& comment, const string& comment_to) {
	string command = "sendtoaddress";
	Value params, result;
...
string CBitcoinAPI::sendfrom(const string& fromaccount, const string& tobitcoinaddress, double amount) {
...
string CBitcoinAPI::sendfrom(const string& fromaccount, const string& tobitcoinaddress, double amount, const string& comment, const string& comment_to, int minconf) {
	string command = "sendfrom";
	Value params, result;
...
string CBitcoinAPI::sendmany(const string& fromaccount, const map<string,double>& amounts) {
...
string CBitcoinAPI::sendmany(const string& fromaccount, const map<string,double>& amounts, const string comment, int minconf) {
	string command = "sendmany";
	Value params, result;
...
vector<unspenttxout_t> CBitcoinAPI::listunspent(int minconf, int maxconf) {
...
vector<txout_t> CBitcoinAPI::listlockunspent() {
...
bool CBitcoinAPI::lockunspent(bool unlock, const vector<txout_t>& outputs) {
...
/* === Mining functions === */
string CBitcoinAPI::getbestblockhash() {
...
string CBitcoinAPI::getblockhash(int blocknumber) {
...
blockinfo_t CBitcoinAPI::getblock(const string& blockhash) {
...
void CBitcoinAPI::setgenerate(bool generate, int genproclimit) {
...
double CBitcoinAPI::getdifficulty() {
...
mininginfo_t CBitcoinAPI::getmininginfo() {
...
blocktemplate_t CBitcoinAPI::getblocktemplate() {
	string command = "getblocktemplate";
	Value params, result;

	// do not accept other parameters in this case
	// let's just use the default (accepting all)
	Value rules(Json::arrayValue);
	rules.append("segwit");  // accept Segregated Witness
	rules.append("taproot");  // accept Taproot
	rules.append("csv");  // accept CheckSequenceVerify
	Value template_request(Json::objectValue);
    template_request["rules"] = rules;
	params.append(template_request);
	...
	for (ValueIterator it1 = result["capabilities"].begin(); it1 != result["capabilities"].end(); it1++) {
		ret.capabilities.push_back((*it1).asString());
	}

	for (ValueIterator it2 = result["coinbaseaux"].begin(); it2 != result["coinbaseaux"].end(); it2++) {
        ret.coinbaseaux[it2.key().asString()] = (*it2).asString();
    }

	ret.coinbasevalue = result["coinbasevalue"].asUInt64();
	ret.curtime = result["curtime"].asUInt64();
	ret.default_witness_commitment = result["default_witness_commitment"].asString();
	ret.height = result["height"].asInt();
	ret.longpollid = result["longpollid"].asString();
	ret.mintime = result["mintime"].asUInt64();

	for (ValueIterator it3 = result["mutable"].begin(); it3 != result["mutable"].end(); it3++) {
		ret.mutablefields.push_back((*it3).asString());
	}

	ret.noncerange = result["noncerange"].asString();
	ret.previousblockhash = result["previousblockhash"].asString();

	for (ValueIterator it4 = result["rules"].begin(); it4 != result["rules"].end(); it4++) {
		ret.rules.push_back((*it4).asString());
	}

	ret.sigoplimit = result["sigoplimit"].asInt();
	ret.sizelimit = result["sizelimit"].asInt();
	ret.target = result["target"].asString();

	for (ValueIterator it5 = result["transactions"].begin(); it5 != result["transactions"].end(); it5++) {
		ret.transactions.push_back((*it5));
	}

	for (ValueIterator it6 = result["vbavailable"].begin(); it6 != result["vbavailable"].end(); it6++) {
        ret.coinbaseaux[it6.key().asString()] = (*it6).asInt();
    }

	ret.vbrequired = result["vbrequired"].asInt();
	ret.version = result["version"].asUInt();
	ret.weightlimit = result["weightlimit"].asInt();

	return ret;
}

std::string CBitcoinAPI::submitblock(const std::string& nextblockstring) {
	string command = "submitblock";
	Value params, result;

	params.append(nextblockstring);
	result = sendcommand(command, params);

	// returns null json if successful and string data if not, see BIP22
	return result.asString();
}

txsinceblock_t CBitcoinAPI::listsinceblock(const string& blockhash, int target_confirmations) {
...
getrawtransaction_t CBitcoinAPI::getrawtransaction(const string& txid, int verbose) {
...
decodescript_t CBitcoinAPI::decodescript(const std::string& hexString) {
...
decoderawtransaction_t CBitcoinAPI::decoderawtransaction(const string& hexString) {
...
string CBitcoinAPI::sendrawtransaction(const string& hexString, bool highFee) {
...
string CBitcoinAPI::createrawtransaction(const vector<txout_t>& inputs, const map<string,double>& amounts) {
...
string CBitcoinAPI::createrawtransaction(const vector<txout_t>& inputs, const map<string,string>& amounts) {
	string command = "createrawtransaction";
	Value params, result;
...
signrawtransaction_t CBitcoinAPI::signrawtransaction(const string& rawTx, const vector<signrawtxin_t> inputs) {
...
signrawtransaction_t CBitcoinAPI::signrawtransaction(const string& rawTx, const vector<signrawtxin_t> inputs, const vector<string>& privkeys, const string& sighashtype) {
	string command = "signrawtransaction";
	Value params, result;
	signrawtransaction_t ret;
...
vector<string> CBitcoinAPI::getrawmempool() {
...
string CBitcoinAPI::getrawchangeaddress() {
...
utxoinfo_t CBitcoinAPI::gettxout(const std::string& txid, int n, bool includemempool) {
...
utxosetinfo_t CBitcoinAPI::gettxoutsetinfo() {
